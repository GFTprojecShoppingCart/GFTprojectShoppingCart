...
public class CartsData {
    ...
    public static Cart createCart001() {
        return new Cart(1L, Status.DRAFT, BigDecimal.ZERO, BigDecimal.ZERO);
    }

    public static Cart createCart002() {
        return new Cart(2L, Status.DRAFT, new BigDecimal("13"), BigDecimal.ZERO);
    }

    public static Cart createCart003() {
        return new Cart(3L, Status.DRAFT, new BigDecimal("80"), BigDecimal.ZERO);
    }

    public static Cart createCart004() {
        return new Cart(4L, Status.SUBMITTED, new BigDecimal("80"),  BigDecimal.ZERO);
    }
